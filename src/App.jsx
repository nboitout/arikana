                ...
                <div className="space-y-2 mb-4">
                  {futureBookings.slice(0, 2).map((booking) => (
                    <button
                      ...
                      className="w-full text-left bg-gradient-to-r rounded-3xl p-5 text-white hover:opacity-85 transition-opacity"
                      ...
                      <>
                        <div className="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
                          ...
                          <p className="text-xs text-red-700">
                            Cancellations are not allowed within 2 hours of the class start time. Please contact support if you need to cancel urgently.
                          </p>
                        </div>
                        <button
                          onClick={() => setBookingToCancel(null)}
